-- ============================================================================
-- Cantado — datos de ejemplo
-- ----------------------------------------------------------------------------
-- Se ejecuta con `supabase db reset`. Crea dos grupos con integrantes distintos
...
--
-- Las contraseñas existen sólo para que los tests E2E puedan iniciar sesión sin
-- pasar por el mail. La aplicación real usa Magic Link.
-- ============================================================================
...
begin
  insert into auth.users (
    ...
    p_email, extensions.crypt('cantado123', extensions.gen_salt('bf')),
  ...
  insert into auth.identities (
    ...
    extensions.gen_random_uuid(), p_id::text, p_id,
